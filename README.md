...
Dieses Repository enthält das Begleitmaterial zu meinem selbst verfassten Fachbuch, das die vollständige Ausarbeitung der ersten fünf Praktikumsaufgaben des Moduls Informationssysteme I umfasst. Anhand eines durchgehenden Beispiels zeige ich, wie relationale Datenbanken für ein Handelsunternehmen modelliert und Schritt für Schritt mit SQL umgesetzt werden. Von den ersten SQL-Anweisungen über `CREATE TABLE`, `ALTER TABLE`, `INSERT`, über Schlüsselkonzepte und Integritätsbedingungen, bis hin zu komplexe Queries, Views und Erweiterungen.
